...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,    KC_B,  KC_BSPC,  KC_N,       KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______, _______, \
  KC_ESC, KC_LALTE, KC_LALTE,KC_LGUI,KC_LSANDS, LOWERD, KC_ESC,   RAISEE,  KC_RSANDS  , KC_RGUI, KC_RALTK, KC_RALTK, _______, ADJUST
),
...
[_ADJUST] = LAYOUT( \
  RESET,   KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_SLCK, KC_PAUSE, _______, _______, _______, _______, KC_BSPC, \
  _______, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, _______, _______, _______, _______, _______, KC_ENT, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),
