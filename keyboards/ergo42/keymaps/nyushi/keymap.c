...
[_QWERTY] = LAYOUT( \
  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,   KC_T,  _______/*MY_BAKUHA*/,  KC_Y,    KC_U,       KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,\
  KC_LCTL,  KC_A,    KC_S,    KC_D,    KC_F,   KC_G,  KC_ENT,               KC_H,    KC_J,       KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLASH,\
  KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,    KC_B,  KC_BSPC,              KC_N,       KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_HOME, _______, \
  ADJUST, _______, KC_LALTE,KC_LGUIE,KC_LSANDS, LOWERD, KC_ESC,             RAISEE,  KC_RSANDS  , KC_RGUIK, KC_RALTK, _______, KC_END, ADJUST
),
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______, KC_PGDOWN,  KC_PGUP, _______, _______, _______, _______, \
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______,  _______, _______, _______, _______,  KC_MS_LEFT,KC_MS_DOWN,KC_MS_UP,KC_MS_RIGHT, KC_LCBR, KC_RCBR, KC_PIPE, \
  _______, _______, _______,  _______, _______, _______, _______, KC_MS_BTN2, KC_MS_WH_UP, KC_MS_WH_DOWN, _______, KC_QUESTION, KC_HOME,   KC_END, \
...
[_ADJUST] = LAYOUT( \
  RESET,   KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_PAUSE, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, \
  _______, _______, _______, _______, _______, _______, KC_SLCK, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),
