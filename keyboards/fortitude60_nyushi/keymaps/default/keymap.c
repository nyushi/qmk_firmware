...
[_RAISE] = LAYOUT( \
  ...
  KC_GRV,  KC_1, KC_MS_U,   KC_3,    KC_4,    KC_5,                       KC_6,    KC_SLCK, KC_PAUSE,    KC_9,    KC_SLCK,    KC_PAUSE, \
  KC_DEL,  KC_MS_L, KC_MS_D, KC_MS_R, KC_F4,   KC_F5,             KC_F6,KC_PGUP,  KC_EQL, KC_UP, KC_UP,    KC_BSLS, \
  _______, KC_ACL0, KC_ACL1, KC_ACL2,   KC_F10,  KC_F11,  _______, _______,  KC_F12,  KC_PGDOWN, KC_LEFT, KC_DOWN, KC_RGHT, _______, \
              _______, _______, KC_SPC, KC_BTN1, KC_BTN2, _______,  _______, _______, _______, _______\
),
...
[_ADJUST] =  LAYOUT( \
  ...
  _______, RESET  , RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI,                   RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, RGB_MOD, KC_BSPC, \
  RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,RGB_M_SN,RGB_M_K,                   RGB_M_X, RGB_M_G, RGB_M_T, _______, _______, _______, \
  KC_LSFT, QWERTY,  COLEMAK, DVORAK,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
                    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______\
)
